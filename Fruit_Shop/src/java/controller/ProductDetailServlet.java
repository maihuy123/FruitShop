...
public class ProductDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Product pro = dao.getProById(proId);
        int proCateId = pro.getCateId();
        List<Product> listRel = dao.getAllProByCaId(proCateId);
        request.setAttribute("listRe", listRel);
        int prId = Integer.parseInt(proId);
        Discount discount = dao.getDiscountByPrID(prId);
        request.setAttribute("dico", discount);
