<%-- 
    Document   : addProduct
    Created on : Jul 3, 2024, 11:31:15 PM
    Author     : tuong
--%>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form class="form form-horizontal" action="addproduct" method="post">
                                                <c:set value="${requestScope.detail}" var="pr"></c:set>
                                                    <div class="form-body">
                                                        ...
                                                        <div class="col-md-8 form-group">
                                                            <input type="text" class="form-control" name="img" placeholder="Paste Image link here" value="${pr.img}">
                                                        </div>
